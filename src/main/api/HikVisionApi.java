...
public interface HikVisionApi {
     ...
     * @apiParam {String} areaId 必须 | 城区id
     ...
     * @apiParam {String} positionX 必须 | 地点坐标X
     * @apiParam {String} positionY 必须 | 地点坐标Y
     ...
     *
     * @apiParam {String} token 身份验证
     * @apiParam {String} areaId 非必须 | 城区id
